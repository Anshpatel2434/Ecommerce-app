...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed top-0 border-r-2 min-h-screen flex flex-col border-gray-700 shadow-xl left-0 z-40 md:w-64 w-screen h-screen transition-transform translate-x-0">
      ...
      <button
        ...
        className="w-full bg-gray-800 py-2 border-t-2 border-t-gray-700 flex justify-center items-center"
      >
