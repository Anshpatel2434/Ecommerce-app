...
const ProfileSection = () => {
  ...
  return (
    <section className="bg-[#071e34] mt-16 flex font-medium items-center justify-center min-h-screen">
      <section className="mx-auto bg-[#20354b] rounded-2xl flex flex-col justify-center items-center px-8 py-6 shadow-lg w-full max-w-md md:max-w-lg lg:max-w-xl">
        <div className="mt-6 w-fit mx-auto">
          <div className="rounded-full font-playwrite flex items-center justify-center text-3xl text-white w-28 h-28 border-2 border-white">
          ...
          <table className="text-white text-xl tracking-wide w-full">
            <tbody>
              ...
              <tr className="mt-4 flex flex-col break-all">
                ...
                <td className="flex">
                  {" "}
                  <FaArrowRight className="mr-2 mt-[0.3rem]" size={20} />{" "}
                  {user.email}
                </td>
              </tr>
              <tr className="mt-4 flex flex-col  break-all whitespace-normal">
                ...
                <td className="flex">
                  ...
                  Nilkanthvarni Society, Opp Vasna Bus Stop, Ahmedabad, Gujarat,
                  India
                </td>
              </tr>
            </tbody>
